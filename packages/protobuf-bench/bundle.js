...
// src/gen/google-protobuf/buf/alpha/breaking/v1/config_pb.js
var require_config_pb = __commonJS({
  "src/gen/google-protobuf/buf/alpha/breaking/v1/config_pb.js"(exports2) {
    "use strict";
    ...
    goog2.exportSymbol("proto.buf.alpha.breaking.v1.Config", null, global2);
    goog2.exportSymbol("proto.buf.alpha.breaking.v1.IDPaths", null, global2);
    proto.buf.alpha.breaking.v1.Config = function(opt_data) {
      jspb2.Message.initialize(this, opt_data, 0, -1, proto.buf.alpha.breaking.v1.Config.repeatedFields_, null);
    };
    goog2.inherits(proto.buf.alpha.breaking.v1.Config, jspb2.Message);
    ...
    proto.buf.alpha.breaking.v1.IDPaths = function(opt_data) {
      jspb2.Message.initialize(this, opt_data, 0, -1, proto.buf.alpha.breaking.v1.IDPaths.repeatedFields_, null);
    };
    goog2.inherits(proto.buf.alpha.breaking.v1.IDPaths, jspb2.Message);
    if (goog2.DEBUG && !COMPILED) {
    ...
    if (jspb2.Message.GENERATE_TO_OBJECT) {
      ...
      proto.buf.alpha.breaking.v1.Config.toObject = function(includeInstance, msg) {
        var f2, obj = {
          version: jspb2.Message.getFieldWithDefault(msg, 1, ""),
          useIdsList: (f2 = jspb2.Message.getRepeatedField(msg, 2)) == null ? void 0 : f2,
          exceptIdsList: (f2 = jspb2.Message.getRepeatedField(msg, 3)) == null ? void 0 : f2,
          ignorePathsList: (f2 = jspb2.Message.getRepeatedField(msg, 4)) == null ? void 0 : f2,
          ignoreIdPathsList: jspb2.Message.toObjectList(
            msg.getIgnoreIdPathsList(),
            proto.buf.alpha.breaking.v1.IDPaths.toObject,
            includeInstance
          ),
          ignoreUnstablePackages: jspb2.Message.getBooleanFieldWithDefault(msg, 6, false)
        };
        if (includeInstance) {
    ...
    proto.buf.alpha.breaking.v1.Config.deserializeBinary = function(bytes2) {
      var reader = new jspb2.BinaryReader(bytes2);
    ...
    proto.buf.alpha.breaking.v1.Config.serializeBinaryToWriter = function(message, writer) {
      ...
      f2 = message.getIgnoreIdPathsList();
      if (f2.length > 0) {
      ...
      f2 = message.getIgnoreUnstablePackages();
      if (f2) {
        writer.writeBool(
          6,
          f2
    ...
    proto.buf.alpha.breaking.v1.Config.prototype.getIgnoreIdPathsList = function() {
      return (
        /** @type{!Array<!proto.buf.alpha.breaking.v1.IDPaths>} */
        jspb2.Message.getRepeatedWrapperField(this, proto.buf.alpha.breaking.v1.IDPaths, 5)
      );
    };
    ...
    proto.buf.alpha.breaking.v1.Config.prototype.addIgnoreIdPaths = function(opt_value, opt_index) {
      return jspb2.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.buf.alpha.breaking.v1.IDPaths, opt_index);
    };
    ...
    if (jspb2.Message.GENERATE_TO_OBJECT) {
      ...
      proto.buf.alpha.breaking.v1.IDPaths.toObject = function(includeInstance, msg) {
        var f2, obj = {
          id: jspb2.Message.getFieldWithDefault(msg, 1, ""),
          pathsList: (f2 = jspb2.Message.getRepeatedField(msg, 2)) == null ? void 0 : f2
        };
        if (includeInstance) {
          obj.$jspbMessageInstance = msg;
        }
    ...
    proto.buf.alpha.breaking.v1.IDPaths.deserializeBinary = function(bytes2) {
      var reader = new jspb2.BinaryReader(bytes2);
    ...
    goog2.object.extend(exports2, proto.buf.alpha.breaking.v1);
  }
});

// src/gen/google-protobuf/buf/alpha/lint/v1/config_pb.js
var require_config_pb2 = __commonJS({
  "src/gen/google-protobuf/buf/alpha/lint/v1/config_pb.js"(exports2) {
    "use strict";
    var jspb2 = require_google_protobuf();
    var goog2 = jspb2;
    var global2 = typeof globalThis !== "undefined" && globalThis || typeof window !== "undefined" && window || typeof global2 !== "undefined" && global2 || typeof self !== "undefined" && self || function() {
    ...
    goog2.exportSymbol("proto.buf.alpha.lint.v1.Config", null, global2);
    goog2.exportSymbol("proto.buf.alpha.lint.v1.IDPaths", null, global2);
    proto.buf.alpha.lint.v1.Config = function(opt_data) {
      jspb2.Message.initialize(this, opt_data, 0, -1, proto.buf.alpha.lint.v1.Config.repeatedFields_, null);
    };
    goog2.inherits(proto.buf.alpha.lint.v1.Config, jspb2.Message);
    if (goog2.DEBUG && !COMPILED) {
    ...
    proto.buf.alpha.lint.v1.IDPaths = function(opt_data) {
      jspb2.Message.initialize(this, opt_data, 0, -1, proto.buf.alpha.lint.v1.IDPaths.repeatedFields_, null);
    };
    goog2.inherits(proto.buf.alpha.lint.v1.IDPaths, jspb2.Message);
    if (goog2.DEBUG && !COMPILED) {
    ...
    if (jspb2.Message.GENERATE_TO_OBJECT) {
      ...
      proto.buf.alpha.lint.v1.Config.toObject = function(includeInstance, msg) {
        var f2, obj = {
          ...
          enumZeroValueSuffix: jspb2.Message.getFieldWithDefault(msg, 6, ""),
          rpcAllowSameRequestResponse: jspb2.Message.getBooleanFieldWithDefault(msg, 7, false),
          rpcAllowGoogleProtobufEmptyRequests: jspb2.Message.getBooleanFieldWithDefault(msg, 8, false),
          rpcAllowGoogleProtobufEmptyResponses: jspb2.Message.getBooleanFieldWithDefault(msg, 9, false),
          serviceSuffix: jspb2.Message.getFieldWithDefault(msg, 10, ""),
          allowCommentIgnores: jspb2.Message.getBooleanFieldWithDefault(msg, 11, false)
        };
        if (includeInstance) {
          obj.$jspbMessageInstance = msg;
        }
    ...
    proto.buf.alpha.lint.v1.Config.deserializeBinary = function(bytes2) {
      var reader = new jspb2.BinaryReader(bytes2);
    ...
    proto.buf.alpha.lint.v1.Config.serializeBinaryToWriter = function(message, writer) {
      ...
      f2 = message.getEnumZeroValueSuffix();
      if (f2.length > 0) {
        writer.writeString(
          6,
          f2
      ...
      f2 = message.getRpcAllowSameRequestResponse();
      if (f2) {
        writer.writeBool(
          7,
          f2
      ...
      f2 = message.getRpcAllowGoogleProtobufEmptyRequests();
      if (f2) {
        writer.writeBool(
          8,
          f2
      ...
      f2 = message.getRpcAllowGoogleProtobufEmptyResponses();
      if (f2) {
        writer.writeBool(
          9,
          f2
      ...
      f2 = message.getAllowCommentIgnores();
      if (f2) {
        writer.writeBool(
          11,
          f2
    ...
    proto.buf.alpha.lint.v1.Config.prototype.getIgnoreIdPathsList = function() {
      return (
        /** @type{!Array<!proto.buf.alpha.lint.v1.IDPaths>} */
        jspb2.Message.getRepeatedWrapperField(this, proto.buf.alpha.lint.v1.IDPaths, 5)
      );
    };
    ...
    proto.buf.alpha.lint.v1.Config.prototype.addIgnoreIdPaths = function(opt_value, opt_index) {
      return jspb2.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.buf.alpha.lint.v1.IDPaths, opt_index);
    };
    ...
    proto.buf.alpha.lint.v1.Config.prototype.getRpcAllowGoogleProtobufEmptyRequests = function() {
      return (
        /** @type {boolean} */
        jspb2.Message.getBooleanFieldWithDefault(this, 8, false)
      );
    };
    proto.buf.alpha.lint.v1.Config.prototype.setRpcAllowGoogleProtobufEmptyRequests = function(value) {
      return jspb2.Message.setProto3BooleanField(this, 8, value);
    };
    ...
    proto.buf.alpha.lint.v1.IDPaths.deserializeBinary = function(bytes2) {
      var reader = new jspb2.BinaryReader(bytes2);
    ...
    goog2.object.extend(exports2, proto.buf.alpha.lint.v1);
  }
});
...
var require_timestamp_pb = __commonJS({
  "../../node_modules/google-protobuf/google/protobuf/timestamp_pb.js"(exports2) {
    ...
    proto.google.protobuf.Timestamp.deserializeBinary = function(bytes2) {
      var reader = new jspb2.BinaryReader(bytes2);
...
// src/gen/google-protobuf/buf/alpha/module/v1alpha1/module_pb.js
var require_module_pb = __commonJS({
  "src/gen/google-protobuf/buf/alpha/module/v1alpha1/module_pb.js"(exports2) {
    "use strict";
    var jspb2 = require_google_protobuf();
    var goog2 = jspb2;
    var global2 = typeof globalThis !== "undefined" && globalThis || typeof window !== "undefined" && window || typeof global2 !== "undefined" && global2 || typeof self !== "undefined" && self || function() {
    ...
    var buf_alpha_breaking_v1_config_pb = require_config_pb();
    goog2.object.extend(proto, buf_alpha_breaking_v1_config_pb);
    var buf_alpha_lint_v1_config_pb = require_config_pb2();
    goog2.object.extend(proto, buf_alpha_lint_v1_config_pb);
    var google_protobuf_timestamp_pb = require_timestamp_pb();
    goog2.object.extend(proto, google_protobuf_timestamp_pb);
    goog2.exportSymbol("proto.buf.alpha.module.v1alpha1.Module", null, global2);
    goog2.exportSymbol("proto.buf.alpha.module.v1alpha1.ModuleFile", null, global2);
    goog2.exportSymbol("proto.buf.alpha.module.v1alpha1.ModulePin", null, global2);
    goog2.exportSymbol("proto.buf.alpha.module.v1alpha1.ModuleReference", null, global2);
    proto.buf.alpha.module.v1alpha1.Module = function(opt_data) {
      jspb2.Message.initialize(this, opt_data, 0, -1, proto.buf.alpha.module.v1alpha1.Module.repeatedFields_, null);
    };
    goog2.inherits(proto.buf.alpha.module.v1alpha1.Module, jspb2.Message);
    if (goog2.DEBUG && !COMPILED) {
    ...
    goog2.inherits(proto.buf.alpha.module.v1alpha1.ModuleFile, jspb2.Message);
    if (goog2.DEBUG && !COMPILED) {
    ...
    goog2.inherits(proto.buf.alpha.module.v1alpha1.ModuleReference, jspb2.Message);
    if (goog2.DEBUG && !COMPILED) {
    ...
    goog2.inherits(proto.buf.alpha.module.v1alpha1.ModulePin, jspb2.Message);
    if (goog2.DEBUG && !COMPILED) {
    ...
    if (jspb2.Message.GENERATE_TO_OBJECT) {
      ...
      proto.buf.alpha.module.v1alpha1.Module.toObject = function(includeInstance, msg) {
        var f2, obj = {
          filesList: jspb2.Message.toObjectList(
            msg.getFilesList(),
            proto.buf.alpha.module.v1alpha1.ModuleFile.toObject,
            includeInstance
          ),
          dependenciesList: jspb2.Message.toObjectList(
            msg.getDependenciesList(),
            proto.buf.alpha.module.v1alpha1.ModulePin.toObject,
            includeInstance
          ),
          documentation: jspb2.Message.getFieldWithDefault(msg, 3, ""),
          breakingConfig: (f2 = msg.getBreakingConfig()) && buf_alpha_breaking_v1_config_pb.Config.toObject(includeInstance, f2),
          lintConfig: (f2 = msg.getLintConfig()) && buf_alpha_lint_v1_config_pb.Config.toObject(includeInstance, f2)
        };
        if (includeInstance) {
          obj.$jspbMessageInstance = msg;
        }
    ...
    proto.buf.alpha.module.v1alpha1.Module.deserializeBinary = function(bytes2) {
      var reader = new jspb2.BinaryReader(bytes2);
    ...
    proto.buf.alpha.module.v1alpha1.Module.serializeBinaryToWriter = function(message, writer) {
      ...
      f2 = message.getDependenciesList();
      if (f2.length > 0) {
        writer.writeRepeatedMessage(
          2,
          f2,
    ...
    proto.buf.alpha.module.v1alpha1.Module.prototype.getFilesList = function() {
      return (
        /** @type{!Array<!proto.buf.alpha.module.v1alpha1.ModuleFile>} */
        jspb2.Message.getRepeatedWrapperField(this, proto.buf.alpha.module.v1alpha1.ModuleFile, 1)
      );
    };
    ...
    proto.buf.alpha.module.v1alpha1.Module.prototype.addFiles = function(opt_value, opt_index) {
      return jspb2.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.buf.alpha.module.v1alpha1.ModuleFile, opt_index);
    };
    ...
    proto.buf.alpha.module.v1alpha1.Module.prototype.getDependenciesList = function() {
      return (
        /** @type{!Array<!proto.buf.alpha.module.v1alpha1.ModulePin>} */
        jspb2.Message.getRepeatedWrapperField(this, proto.buf.alpha.module.v1alpha1.ModulePin, 2)
      );
    };
    ...
    proto.buf.alpha.module.v1alpha1.Module.prototype.addDependencies = function(opt_value, opt_index) {
      return jspb2.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.buf.alpha.module.v1alpha1.ModulePin, opt_index);
    };
    ...
    proto.buf.alpha.module.v1alpha1.Module.prototype.getBreakingConfig = function() {
      return (
        /** @type{?proto.buf.alpha.breaking.v1.Config} */
        jspb2.Message.getWrapperField(this, buf_alpha_breaking_v1_config_pb.Config, 4)
      );
    };
    ...
    proto.buf.alpha.module.v1alpha1.Module.prototype.clearBreakingConfig = function() {
      return this.setBreakingConfig(void 0);
    };
    ...
    proto.buf.alpha.module.v1alpha1.Module.prototype.getLintConfig = function() {
      return (
        /** @type{?proto.buf.alpha.lint.v1.Config} */
        jspb2.Message.getWrapperField(this, buf_alpha_lint_v1_config_pb.Config, 5)
      );
    };
    ...
    proto.buf.alpha.module.v1alpha1.Module.prototype.clearLintConfig = function() {
      return this.setLintConfig(void 0);
    };
    ...
    proto.buf.alpha.module.v1alpha1.ModuleFile.deserializeBinary = function(bytes2) {
      var reader = new jspb2.BinaryReader(bytes2);
    ...
    if (jspb2.Message.GENERATE_TO_OBJECT) {
      ...
      proto.buf.alpha.module.v1alpha1.ModuleReference.toObject = function(includeInstance, msg) {
        var f2, obj = {
          remote: jspb2.Message.getFieldWithDefault(msg, 1, ""),
          owner: jspb2.Message.getFieldWithDefault(msg, 2, ""),
          repository: jspb2.Message.getFieldWithDefault(msg, 3, ""),
          reference: jspb2.Message.getFieldWithDefault(msg, 4, "")
        };
        if (includeInstance) {
          obj.$jspbMessageInstance = msg;
        }
    ...
    proto.buf.alpha.module.v1alpha1.ModuleReference.deserializeBinary = function(bytes2) {
      var reader = new jspb2.BinaryReader(bytes2);
    ...
    if (jspb2.Message.GENERATE_TO_OBJECT) {
      ...
      proto.buf.alpha.module.v1alpha1.ModulePin.toObject = function(includeInstance, msg) {
        var f2, obj = {
          ...
          owner: jspb2.Message.getFieldWithDefault(msg, 2, ""),
          repository: jspb2.Message.getFieldWithDefault(msg, 3, ""),
          branch: jspb2.Message.getFieldWithDefault(msg, 4, ""),
          commit: jspb2.Message.getFieldWithDefault(msg, 5, ""),
          digest: jspb2.Message.getFieldWithDefault(msg, 6, ""),
          createTime: (f2 = msg.getCreateTime()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f2)
        };
        if (includeInstance) {
          obj.$jspbMessageInstance = msg;
        }
    ...
    proto.buf.alpha.module.v1alpha1.ModulePin.deserializeBinary = function(bytes2) {
      var reader = new jspb2.BinaryReader(bytes2);
    ...
    goog2.object.extend(exports2, proto.buf.alpha.module.v1alpha1);
  }
});

// src/entry-google-protobuf.js
var import_module_pb = __toESM(require_module_pb());
var file = new import_module_pb.ModuleFile();
file.setPath("foo.proto");
var module2 = new import_module_pb.Module();
module2.addFiles(file);
var bytes = module2.serializeBinary();
